 ...
 */
class SingleExcelMlc(override val filename: String, override val targetIndex: Int) : Mlc {
    ...
    override fun writeFile() {
        ...
        File(targetFile.parent).apply { if (!exists()) mkdir() }
    ...
    companion object {
        fun filename(targetDic: String, lang: Lang): String {
            return "${targetDic}excel/${lang.name}.xls"
        }
    }
